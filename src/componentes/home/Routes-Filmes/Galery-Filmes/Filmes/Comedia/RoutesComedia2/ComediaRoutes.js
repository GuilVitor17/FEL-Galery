...
import FilmesAcaoInfomacoesRoutes from "../../Comedia/RoutesComedia1/FilmesComediaRoutes";

const ComediafilmesRoutes = () => {
  ...
  useEffect(()=>{ 
    const fetchUsers = async () => { 
     ...
     await fetch(`http://localhost:3005/Acao`, {
        method:'GET',
        headers:{
...
export default ComediafilmesRoutes