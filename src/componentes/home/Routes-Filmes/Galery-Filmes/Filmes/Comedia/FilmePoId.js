...
import FilmesAcao from "../../../Galery-Filmes/Filmes/Acao/Acao";


const filmesPorIdComedia = () => {
  ...
  useEffect(() => {
    ...
    const fetchUsers = async () => {
      try {
        ...
        await fetch(`http://localhost:3005/filmecomedia/${user}`, {
          method: 'GET',
          headers: {
        ...
        <div className="div-inf-filmes">
          ...
          <div className="center-infor-filmes">
            ...
            <div className="description-id">
              ...
              <a href={filmes.linkFilme}><div className="button-livro-id"><button>BAIXAR</button></div></a>
            </div>
...
export default filmesPorIdComedia